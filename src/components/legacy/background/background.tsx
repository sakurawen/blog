...
function Grids({
  ...
  return (
    <svg
      className='pointer-events-none size-full  touch-none select-none bg-transparent'
      version='1.1'
...
export function Background() {
  return (
    <>
      ...
      <span className='pointer-events-none fixed inset-0 -z-[1] size-full'>
        <Grids grid={10} />
      </span>
      ...
      <div className='mask-b z-1 pointer-events-none fixed inset-x-0 bottom-0 h-[80px] w-full select-none backdrop-blur-[1px]' />
    </>
  );
}
